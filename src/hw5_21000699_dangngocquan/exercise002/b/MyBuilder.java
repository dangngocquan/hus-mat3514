...
public class MyBuilder {
    ...
    private static void fillSampleDataTree(ExpressionTree tree) {
        tree.addRoot("*");
        LinkedBinaryTree.LinkedBinaryTreeNode<String> node0 = tree.root();
        tree.addLeft(node0, "+");
        tree.addRight(node0, "-");
        LinkedBinaryTree.LinkedBinaryTreeNode<String> node00 = tree.left(node0);
        LinkedBinaryTree.LinkedBinaryTreeNode<String> node01 = tree.right(node0);
        tree.addLeft(node00, "/");
        tree.addRight(node00, "2");
        tree.addLeft(node01, "7");
        tree.addRight(node01, "4");
        LinkedBinaryTree.LinkedBinaryTreeNode<String> node000 = tree.left(node00);
